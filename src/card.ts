...
function setupCard(w: number, h: number) {
  ...
  ctx.roundRect(0, 0, w, h, size * 0.75).clip();
  ctx.fill();
...
export async function smallCard(opts?: Options) {
  ...
  ctx.drawImage(await images.status[opts.status], -size * 0.3, -size * 0.3, size * 0.6, size * 0.6);
  ctx.restore();
  ...
  ctx.save();
  ctx.translate(size * 0.5, size * 0.3 + size * 0.65);
  ctx.changeFontSize(size * 0.65 + 'px');
  ctx.fillText(opts.name, size * 0.1, 0, size * 5);
  ...
  ctx.drawImage(await images.icons.server, size * 0.125, size * 0.125, size * 0.75, size * 0.75);
  ctx.fillText(fancyCount(opts.guilds), size * 1.5, size * 0.7, size * 2.25);
  ctx.translate(0, size * 1.15);
  ctx.drawImage(await images.icons.vote, size * 0.125, size * 0.125, size * 0.75, size * 0.75);
  ctx.fillText(fancyCount(opts.votes), size * 1.5, size * 0.7, size * 2.25);
  ctx.restore();
...
export async function longCard(opts?: Options) {
  ...
  //
  ctx.fillStyle = colors.blue;
  ctx.changeFontSize(h * 0.17 + 'px');
  ctx.fillText(opts.name, w * 0.3, h * 0.45, w * 0.425);
  ctx.fillStyle = colors.lightgrey;
  ctx.fillText('#', w * 0.3 + w * 0.4375, h * 0.45);
  ctx.fillText(opts.tag, w * 0.3 + w * 0.425 + w * 0.05, h * 0.45, w * 0.15625);
  ...
  if (opts.botList) {
    ...
    ctx.fillStyle = colors.blue;
    ctx.roundRect(w * 0.5, -(w * 0.0625), w * 0.5, h * 0.4, w * 0.0625);
    ctx.fill();
    ctx.fillRect(w * 0.625, 0, w * 0.5, w * 0.0625);
    ctx.fillStyle = 'rgba(0, 0, 0, 0.4)';
    ctx.changeFontSize(h * 0.15 + 'px');
    ctx.fillText(opts.botList, w * 0.55 + h * 0.65, h * 0.15, w * 0.421875);
  }
  ...
  ctx.textAlign = 'left';
  ctx.fillStyle = colors.lightgrey;
  ctx.drawImage(await images.icons.server, w * 0.3, h * 0.65, w * 0.0625, w * 0.0625);
  ctx.changeFontSize(h * 0.15 + 'px');
  ctx.fillText(fancyCount(opts.guilds), w * 0.25 + h * 0.45, h * 0.65 + h * 0.15, h * 0.45);

  ctx.drawImage(await images.icons.vote, w * 0.6, h * 0.65, w * 0.0625, w * 0.0625);
  ctx.fillText(fancyCount(opts.votes), w * 0.55 + h * 0.45, h * 0.65 + h * 0.15, h * 0.45);

  //Library
  //
  if (opts.library) {
    ctx.fillStyle = colors.grey;
    ctx.roundRect(w * 0.875, h * 0.6, h * 0.4, h * 0.4, h * 0.15).clip();
    ctx.fill();
    ctx.drawImage(await images.library[opts.library], w * 0.875, h * 0.6, h * 0.4, h * 0.4);
  }
...
export async function bigCard(opts?: Options) {
  ...
  //
  ctx.fillStyle = colors.grey;
  ctx.roundRect(0, h / 2, w, h, size * 0.75).clip();
  ctx.fill();
  ...
  if (opts.library) {
    ctx.save();
    ctx.fillStyle = colors.darkgrey;
    ctx.roundRect(w * 0.875, h - h * 0.2, h * 0.2, h * 0.2, size * 0.75).clip();
    ctx.fill();
    ctx.drawImage(await images.library[opts.library], w * 0.875, h - h * 0.2, h * 0.2, h * 0.2);
    ctx.restore();
  }
  ...
  //
  ctx.fillStyle = colors.lightgrey;
  ctx.changeFontSize(size * 0.5 + 'px');
  drawMultilineText(ctx, opts.description, {
    rect: {
      x: size * 0.5,
      y: h / 2 + size * 0.5,
      width: w - h * 0.2,
